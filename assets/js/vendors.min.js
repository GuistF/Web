...
! function() {
    ...
    function b(t) {
        ...
        }(a) || (Math.abs(n) > 1.2 && (n *= r.stepSize / 120), Math.abs(a) > 1.2 && (a *= r.stepSize / 120), y(l, n, a), t.preventDefault(), void E()) : !i || !W || (Object.defineProperty(t, "target", {
    ...
    var F, I = window.navigator.userAgent,
        _ = /Edge/.test(I),
        W = /chrome/i.test(I) && !_,
        $ = /safari/i.test(I) && !_,
        U = /mobile/i.test(I),
